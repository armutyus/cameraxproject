...
class ImageFilters {
    ...
    object ImageFiltersCompat {

        fun getImageFiltersList(context: Context, image: Bitmap): List<ImageFilter> {
        ...
        private fun imageFilterList(gpuImage: GPUImage): List<ImageFilter> {
